					...
					<div class="top_content_single row">
						<div class="images images_single_left">
							...
							<div id="slider" class="flexslider">
								<ul class="slides">
									<li>
										<a href="../../images/kashmir/pexels-imad-clicks-11203203.jpg" class="swipebox" title=""><img width="813" height="384" src="../../images/kashmir/pexels-imad-clicks-11203203.jpg" class="attachment-shop_single size-shop_single wp-post-image" alt="" title="" draggable="false"></a>
									</li>
									<li>
...
Arrive Delhi by morning 06:00 am.</p>
									...
									<div role="tabpanel" class="tab-pane single-tour-tabs-panel single-tour-tabs-panel--location_tab panel entry-content wc-tab" id="tab-price-tab">
										<table id="customers">
											<img src="../../images/kashmir/tour-price/magical-Kashmir-price.png" alt="">
								...
								<li class="item-tour col-md-4 col-sm-6 product">
										<div class="item_border item-product">
											...
											<div class="wrapper_content">
												<div class="post_title"><h4>
													<a href="4n-5d-him.php" rel="bookmark">Kashmir Bliss</a>
												</h4></div>
									...
									<li class="item-tour col-md-4 col-sm-6 product">
										<div class="item_border item-product">
											...
											<div class="wrapper_content">
												<div class="post_title"><h4>
													<a href="5n-6d-him.php" rel="bookmark">Explore Kashmir</a>
												</h4></div>
